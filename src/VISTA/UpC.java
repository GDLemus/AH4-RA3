...
public class UpC extends javax.swing.JFrame {
 ...
 int xMouse, yMouse;
    ...
    private void initComponents() {
        ...
        inisiar1.setText("MODIFICAR CLIENTE");
        jPanel1.add(inisiar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 50, 260, -1));
        ...
        textbutom.setText("MODIFICAR CLIENTE");
    ...
    private void enviarC(){
 
        clientesM cm = new clientesM(Integer.parseInt(j_codigoC.getText()), j_nameC.getText(), Integer.parseInt(j_nitC.getText()), j_correoC.getText(), j_generoC.getText());
        ClientesDAORelacional cd = new ClientesDAORelacional();
        cd.modificar_clientes(cm);
    ...
    public void MostrarC(int codigo){
        
        codigo = codigo;
        ClientesDAORelacional cd = new ClientesDAORelacional();
        
clientesM cliente = cd.obtener_clientes(codigo);
     
    
     j_codigoC.setText(cliente.getCodigo()+"");
     j_nameC.setText(cliente.getNombre()+"");
     j_nitC.setText(cliente.getNit()+"");
     j_correoC.setText(cliente.getCorreo()+"");
     j_generoC.setText(cliente.getGenero()+"");
    } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
